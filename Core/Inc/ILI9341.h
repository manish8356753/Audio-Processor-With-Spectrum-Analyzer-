...
void ILI9341_Fill_Rect_BottomUP(unsigned int x0,unsigned int y0, unsigned int x1,unsigned int y1, uint16_t color);
...
//13. Set screen rotation(1:portrait, 2: landscape, 3:inverted portrait, 4:inverted landscape)
